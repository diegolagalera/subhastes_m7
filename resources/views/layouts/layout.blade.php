...
<<<<<<< HEAD
  <link rel="icon" type="image/png" href="dist/img/su.jpg" />
  <title>Subhastas</title>
=======
    <title>{{ config('app.name', 'Laravel') }}</title>
>>>>>>> cbb8f264944be2f5ea596072802769b4b1c258c8
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('users/index') }}"><i class="fa fa-circle-o"></i>Usuaris</a></li>
